  ...
  <header id="header_area" class="header_area">
    <div class="row">
      <div class="header_Logo_area">
        <!--헤더 이미지 로고 영역-->
        <div id="header_page_reload" v-on:click="pageReload">
          <img id="header_img" src="../../assets/images/login/acen_logo.png">
        </div>
      </div>
      <div class="header_list_area">
        <ul class="menu_ul">
          ...
          <li>
            <div class="select" v-on:click="monitoring">악취</div>
          </li>
          <div class="divider"></div>
          <li>
      ...
      <div class="header_right_area">
        <div class="box_button_area" v-on:click="toggle_event">
        ...
        <div class="header_user_control_area" v-if="info_show">
          <div class="common_user_div" id="user_name_area">
            <img src="../../assets/images/setting/setting.png">
            <p>님</p>
          </div>
          <div class="admin_user_div" id="user_authority_area">
            <img src="../../assets/images/setting/setting.png">
            <p>회원관리</p>
          </div>
          <div class="admin_user_div" id="equipment_setting_area">
            <img src="../../assets/images/setting/setting.png">
            <p>설정관리</p>
          </div>
          <div class="admin_user_div" id="map_setting_area">
            <img src="../../assets/images/setting/setting.png">
            <p>맵 설 정</p>
          </div>
          <div v-on:click="userLogout" class="common_user_div" id="logout_area">
            <img src="../../assets/images/setting/setting.png">
            <p>로그아웃</p>
          </div>
        </div>
